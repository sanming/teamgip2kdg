...
import be.kdg.kandoe.frontend.config.security.rest.RestAuthenticationEntryPoint;
import be.kdg.kandoe.frontend.config.security.rest.RestAuthenticationFailureHandler;
import be.kdg.kandoe.frontend.config.security.rest.RestAuthenticationSuccessHandler;
import be.kdg.kandoe.frontend.config.security.rest.RestLogoutSuccessHandler;
