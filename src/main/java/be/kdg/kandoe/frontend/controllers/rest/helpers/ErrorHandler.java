package be.kdg.kandoe.frontend.controllers.rest.helpers;

import be.kdg.kandoe.frontend.controllers.resources.errors.ErrorResource;
import be.kdg.kandoe.frontend.controllers.resources.errors.ValidationErrorResource;
